...
**Skill sources:** `user-agents`, `user-codex`, `project-agents`, `project-codex`
...
**Available frameworks:** `generic`, `crewai`, `langgraph`, `autogen`, `claude-sdk`
...
## Quick Commands
- `skill-load mission-control` — Load this skill
