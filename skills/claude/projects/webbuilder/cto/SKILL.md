---
name: webbuilder-cto
description: CTO operating manual for the AI WebBuilder project. Single source of truth for architecture, workflow standards, and implementation priorities.
---
