...
description: Cost audit tool for Claude Code ECC ecosystem — scans installed skills and rules, calculates token budgets, and identifies optimization opportunities.
---
...
## Quick Commands
- `skill-load ecc-tools-cost-audit` — Load this skill
