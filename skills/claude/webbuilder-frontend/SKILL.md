...
description: webbuilder-frontend skill
  Frontend implementation guide for AI WebBuilder SaaS app. Next.js 14 app router,
  Zustand state, shadcn/ui, streaming SSE, and vibe-starter integration.
version: 1.0.0
category: webbuilder
---
