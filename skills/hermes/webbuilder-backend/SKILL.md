...
description: webbuilder-backend skill
  Backend implementation guide for AI WebBuilder. Covers service architecture,
  DB schema, Docker integration, TypeScript patterns, and testing.
version: 1.1.0
category: webbuilder
---
